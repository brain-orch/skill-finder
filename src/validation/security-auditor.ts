...
import { validateSkillContent, type ValidationMetadata } from "./validator.js";
...
export class SecurityAuditor {
  audit(skill: SkillSearchResult): SecurityAuditResult {
    ...
    const metadata: ValidationMetadata = { name: skill.name, marketplace: skill.marketplace };
    ...
    // Severity level
    let severity: SecurityAuditResult["severity"] = "clean";
