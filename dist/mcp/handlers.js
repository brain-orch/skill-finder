...
// ---------------------------------------------------------------------------
export async function handleSearchSkills(params) {
...
export async function handleRecommendSkills(params) {
...
export async function handleSkillInfo(params) {
...
export async function handleInstallSkill(params) {
    const identifier = params.identifier;
    if (typeof identifier !== "string" || identifier.trim().length === 0) {
        throw new Error("identifier is required and must be non-empty");
    }
