 ...
 */
export function readFileWithTimeout(filePath, timeoutMs = FILE_READ_TIMEOUT_MS) {
    try {
 ...
 */
export function readCargoToml(root) {
 ...
 */
export function readGoMod(root) {
 ...
 */
export function readRequirementsTxt(root) {
 ...
 */
export function depToStack(depName, source) {
