import { STACK_PLANS } from "./plan-helpers.js";
import { discoverPlans, loadPlan } from "./plan-helpers.js";
    ...
    async searchPlanSkills(plan) {
        ...
        for (const skill of plan.skills) {
            try {
                ...
                console.warn("[skill-finder] plan skill search failed:", err instanceof Error ? err.message : String(err));
                results.push([]);
            }
        }
