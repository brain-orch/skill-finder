 ...
 */
export function placeSkillFiles(config, skillName, sourcePath, targetDir) {
 ...
 * Takes config as parameter instead of using this.config
 */
export function lockInstalledSkill(skillName, skillPath) {
    try {
...
//# sourceMappingURL=activation-helpers.js.map