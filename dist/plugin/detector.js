 ...
 */
import { STOP_WORDS, KEYWORD_MAP, EXTENSION_MAP, COMMAND_MAP, } from "./categories.js";
...
export class TaskDetector {
    ...
    analyzeText(text) {
        ...
        const categoryConfidences = new Map();
